...
M566 X800 U800 Y800 Z100 E1500:1500                         ; set maximum instantaneous speed changes (mm/min)
M203 X24000 U24000 Y24000 Z900 E3600:3600                   ; set maximum speeds (mm/min)
M201 X2500 U2500 Y2500 Z100 E1500                           ; set accelerations (mm/s^2)
M906 X1400 U1400 Y1400 Z1200 E1100:1100 I30                 ; set motor currents (mA) and motor idle factor in per cent
...
M208 S1 X-85 U185 Y0 Z0                                            ; set axis minima
M208 S0 X230 U515 Y320 Z600                                      ; set axis maxima
...
; Z-Probe
M558 P5 C"^0.io5.in" H5 F120 T6000                            ; set Z probe type to switch and the dive height + speeds
...
G10 P1 X-63.5 Y-20.6 Z0                                             ; set tool 1 axis offsets
